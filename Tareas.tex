...
\begin{figure}[H]
	\begin{minipage}[b]{.5\linewidth}
		...
		\subcaption{Clasificado usando y = 0.5}\label{fig:horizontal}

		\includegraphics[width = \textwidth]{seccion_vertical}
		\subcaption{Clasificado usando x = 0.5}\label{fig:vertical}

		\includegraphics[width = \textwidth]{seccion_diagonal_ascendente}
		\subcaption{Clasificado usando x}\label{fig:diagonal_a}
	\end{minipage}
	\begin{minipage}[b]{.5\linewidth}
		\includegraphics[width = \textwidth]{seccion_diagonal_descendente}
		\subcaption{Clasificado usando 1-x.}\label{fig:diagonal_d}

		\includegraphics[width = \textwidth]{seccion_cruz}
		\subcaption{Clasificado usando (a) y (b)}\label{fig:cruz}

		\includegraphics[width = \textwidth]{seccion_x}
		\subcaption{Clasificado usando (c) y (d)}\label{fig:x}
	\end{minipage}
	\label{fig:error}
\end{figure}
